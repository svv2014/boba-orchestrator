...
async def run_pool(
    ...
    Args:
        ...
        guardrails: Optional guardrail config for blocked_commands enforcement.

    Returns:
        PoolResult with all worker results.
    """
    pool = WorkerPool(worker, max_parallel=max_parallel, review_orchestrator=review_orchestrator, guardrails=guardrails)
